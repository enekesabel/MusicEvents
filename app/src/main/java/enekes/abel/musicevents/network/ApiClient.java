...
import enekes.abel.musicevents.network.auth.ApiKeyAuth;
import enekes.abel.musicevents.network.auth.HttpBasicAuth;
...
public class ApiClient {
  ...
  public void createDefaultAdapter() {
    ...
    String baseUrl = "https://rest.bandsintown.com";
    if (!baseUrl.endsWith("/"))
      baseUrl = baseUrl + "/";
